...
<body>
	...
	<header>
		<div class="container">
			<h1><a href="dashboard.php">jfruit.id</a></h1>
			<ul>
			...
			<div class="box">
				<form action="" method="POST" enctype="multipart/form-data">
					...
					<select class="input-control" name="status">
						<option value="">--Pilih--</option>
						<option value="1" <?php echo ($p->product_status == 1)? 'selected':''; ?>>Tampilkan</option>
						<option value="0" <?php echo ($p->product_status == 0)? 'selected':''; ?>>Sembunyikan</option>
					</select>
