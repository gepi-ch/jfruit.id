...
<body>
	...
	<header>
		<div class="container">
			<h1><a href="index.php">jfruit.id</a></h1>
			<ul>
        ...
        <div class="container">
            ...
            <div class="box">
                ...
                <div class="col-2">
                    ...
                    <br>
                    <br>
                    <p>Kami pastikan produk kami terjaga mutu dan kualitasnya <br></p>
                    <p>Tertarik dengan produk kami <br></p>
                    <br>
                    <br>
                    <p><a href="https://api.whatsapp.com/send?phone=<?php echo $a->admin_telp ?>&text=Hai, saya tertarik dengan produk Anda." target="_blank">
                        Hubungi kami melalui via Whatsapp
	...
	<div class="footer">
		<div class="container">
        <small>Jillyan and Fahmi Store - 2024</small>
		</div>
	</div>
</body>
</html>